...
app.use(express.static("SmartApp"));
...
client.on("connect", () => {
    ...
    client.subscribe("casadorodolfo/lampada/status");
...
io.on("connection", (socket) => {
    ...
    socket.on("ligar_lampada", () => {
        client.publish("casadorodolfo/lampada/controle", "ON");
        console.log("ligar Lamp");
    });

    socket.on("desligar_lampada", () => {
        client.publish("casadorodolfo/lampada/controle", "OFF");
